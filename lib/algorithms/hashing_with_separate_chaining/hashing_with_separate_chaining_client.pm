package algorithms::hashing_with_separate_chaining::hashing_with_separate_chaining_client;

use strict;
use warnings FATAL => "all";
use Exporter "import";
use constants::lists qw(LIST);
use algorithms::hashing_with_separate_chaining::hashing_with_separate_chaining;
